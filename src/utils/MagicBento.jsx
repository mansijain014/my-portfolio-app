...
const cardData = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Shogun Recorder Monitor 7 Inches" },
      { name: "Atomos Ninja 5 Inches" },
      { name: "Plazma 65 Inches" },
      { name: "Plazma 55 Inches" },
      { name: "Plazma 40 Inches" },
    ],
  },
];
